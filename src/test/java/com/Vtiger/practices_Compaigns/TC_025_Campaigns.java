...
public class TC_025_Campaigns {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//In first dropdown select "Target Audience"

		Select sel=new Select(driver.findElement(By.xpath("//select[@name=\"fcol0\"]")));

		sel.selectByVisibleText("Target Audience");
		...
		String Target_Audience="students";

		driver.findElement(By.xpath("//input[@id=\"fval0\"]")).sendKeys(Target_Audience);

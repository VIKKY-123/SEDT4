...
public class TC_026_Campaigns {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//In first dropdown select "Target Size"

		Select sel=new Select(driver.findElement(By.xpath("//select[@name=\"fcol0\"]")));

		sel.selectByVisibleText("Target Size");
		...
		driver.findElement(By.xpath("//input[@id=\"fval0\"]")).sendKeys(Target_Size);

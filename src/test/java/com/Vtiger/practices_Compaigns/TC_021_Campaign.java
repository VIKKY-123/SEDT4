...
public class TC_021_Campaign {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//Navigate to Advance  Search option
				...
				//In first dropdown select "Created Time"

				Select sel=new Select(driver.findElement(By.xpath("//select[@name=\"fcol0\"]")));
				
				sel.selectByVisibleText("Created Time");
				...
				driver.findElement(By.xpath("//table[@style=\"visibility: visible;\"]/descendant::td[text()='Today']")).click();
				
				
				String date = driver.findElement(By.xpath("//input[@id=\"fval0\"]")).getText();

...
public class TC_024_Campaigns {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@id=\"fval0\"]")).sendKeys(sponsor);

...
public class TC_020_campaigns {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//In first dropdown select "Campaign Type"
		...
		//Navigate to text Box And Enter Campaign Type

		String campaigntype="Conference";

		driver.findElement(By.xpath("//input[@id=\"fval0\"]")).sendKeys(campaigntype);

		driver.findElement(By.xpath("//input[@id=\"fval0\"]")).getText();
